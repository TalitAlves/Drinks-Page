...
export class ComunicatorService {
  ...
  public dbUrl: string = 'http://localhost:3000/drinks?strDrink=';

  public getDrinkDb(drinkName: string): Observable<ApiResponse> {
    return this.http.get<ApiResponse>(`${this.dbUrl}${drinkName}`);
  }
